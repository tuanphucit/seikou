...
jQuery.fn.daterangepicker = function(settings){
	...
	var options = jQuery.extend({
		presetRanges: [
			...
			{text: 'Date to Month', dateStart: 'today', dateEnd: function(){ return Date.parse('today').moveToLastDayOfMonth();  } },
			{text: 'Date to Year', dateStart: 'today', dateEnd: function(){ var x= Date.parse('today'); x.setMonth(11); x.setDate(31); return x; } },
			//extras:
